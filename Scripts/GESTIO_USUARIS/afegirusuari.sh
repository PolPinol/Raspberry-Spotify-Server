	...
	<body>
		<div class="container">
			...
			then
				...
				echo -e "	<div class="center"><h2 class="card-heading">Afegir un usuari</h2>
									<p>El registre del usuari ha sigut satisfactori.</p></div>
										<div class="card-info">
											<p>Tornar al inici</p>
											<div class="action">
				...
				echo "SYS_LOGS: Intent de registre d'usuari fallit." >> /home/pi/Desktop/logs.txt
				echo -e "	<div class="center"><h2 class="card-heading">Afegir un usuari</h2>
													<p>Hi ha hagut un error en el registre del usuari.</p></div>
													<div class="card-info">
