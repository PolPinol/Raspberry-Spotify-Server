...
echo "SYS_LOGS: S'ha eliminat un cron del sistema." >> /home/pi/Desktop/logs.txt
function urldecode() { : "${*//+/ }"; echo -e "${_//%/\\x}"; }

aux1=`echo $QUERY_STRING | awk -F= '{print $2}'`
aux2=`echo $aux1 | awk -F\& '{print $1}'`
cron=$(urldecode "$aux2")
...
aux3=`grep -v "$cron" /home/pi/mycron.txt`
echo "$aux3" > /home/pi/mycron.txt
...
<!DOCTYPE html><html>
	...
	<body>
		<div class="container">
			<div class="card">
				<div class="center">
					<h2 class="card-heading">Eliminar un cron</h2>
				</div><div class="center">
				<p>Cron eliminat</p>
				</br>
				</div>
				<div class="card-info">
					<p>Tornar a la configuració de crons</p>
					<div class="action">
						<form action="cron.sh">
